...
if (!empty($_SESSION['current_user'])) {
                ...
                if (isset($_POST['name']) && !empty($_POST['name']) && isset($_POST['price']) && !empty($_POST['price'])) {
                    ...
                    if (!isset($error)) {
                        if ($_GET['action'] == 'edit' && !empty($_GET['id'])) { //Cập nhật lại sản phẩm
                            ...
                            $result = mysqli_query($con, "INSERT INTO `product` (`id`, `name`, `image`, `price`, `loai`, `mieuta`, `created_time`, `last_updated`) VALUES (NULL, '" . $_POST['name'] . "','" . $image . "', " . str_replace('.', '', $_POST['price']) . ",'" . $_POST['loai'] . "', '" . $_POST['mieuta'] . ",0,', " . time() . ", " . time() . ");");
                        }
   ...
   <div class="wrap-field">
                        ...
                        <input type="text" name="loai" value="<?= (!empty($product) ? $product['loai'] : "") ?>" />
                        <div class="clear-both"></div>
                    </div>
        ...
        <?php } ?>
                    ...
                    <div class="wrap-field">
                        <label>Ghi chú: </label>
                        <textarea name="mieuta"><?= (!empty($product) ? $product['mieuta'] : "") ?></textarea>
                        <div class="clear-both"></div>
                    </div>
                </form>
                <div class="clear-both"></div>
